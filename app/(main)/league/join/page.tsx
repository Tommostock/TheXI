      ...
      <form action={handleSubmit} className="mt-6 space-y-4">
        <div>
          ...
          <input
            ...
            required
            maxLength={6}
            className="mt-1 block w-full rounded-md border border-border bg-bg-card px-3 py-2 text-center text-lg font-mono tracking-widest text-white uppercase placeholder-text-muted focus:border-wc-teal focus:outline-none focus:ring-1 focus:ring-wc-teal"
            placeholder="ABC123"
          />
        </div>
