        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-4">
          <div>
            ...
            <input
              ...
              className="mt-1 block w-full rounded-lg border border-border bg-bg-primary px-3 py-2.5 text-white placeholder-text-muted focus:border-wc-lime focus:outline-none focus:ring-1 focus:ring-wc-lime"
